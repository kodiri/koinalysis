  ...
  makeLabels(){
    ...
    return(
      <g className="linechart_label">
        {/* Y AXIS LABELS */}
        <text transform={`translate(${yLabelSize/1.7}, 20)`} textAnchor="middle">
          {this.getY().max.toLocaleString('us-EN',{ style: 'currency', currency: 'USD' })}
        </text>
        <text transform={`translate(${yLabelSize/1.7}, ${svgHeight - xLabelSize - padding})`} textAnchor="middle">
